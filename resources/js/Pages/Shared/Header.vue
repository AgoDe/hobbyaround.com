    ...
    <nav class="px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HobbyAround</span>
            </a>
                    ...
                    <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li v-if="!$page.props.auth.check">
                                <SubNavLink href="/login" :active="$page.component === 'Auth/Login'">
                                    Accedi
                                </SubNavLink>
                            </li>

                            <li v-if="!$page.props.auth.check">
                                <SubNavLink href="/register" :active="$page.component === 'Auth/Register'">
                                    Registrati
                                </SubNavLink>
                            </li>

                            <li v-if="$page.props.auth.check">
                                <SubNavLink href="#">Dashboard</SubNavLink>
                            </li>
                        </ul>
                        <div v-if="$page.props.auth.check" class="py-1">
                            <SubNavLink href="/logout" method="post" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Logout</SubNavLink>
                        </div>
                    </div>
                </li>
            </ul>
